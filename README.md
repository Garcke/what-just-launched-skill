...
- Product discovery: Product Hunt, Peerlist Launchpad, BetaList, Microlaunch, Uneed, Fazier.
- Feedback and news evidence: Reddit, Hacker News, Stack Exchange, Lobsters, X/Twitter, YouTube, Brave, SerpApi, Tavily.
